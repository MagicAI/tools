    ...
    for dirpath, fpaths in walk(args.imgpath, regex=args.regex):
        for fpath in fpaths:
            if 'SideFrontLeft' in fpath:
                ocam_file = os.path.join(intrinsic_path, 'left_front', 'ocam_intrinsics.txt')
            elif 'SideFrontRight' in fpath:
                ocam_file = os.path.join(intrinsic_path, 'right_front', 'ocam_intrinsics.txt')
            elif 'SideRearLeft' in fpath:
                ocam_file = os.path.join(intrinsic_path, 'left_rear', 'ocam_intrinsics.txt')
            elif 'SideRearRight' in fpath:
                ocam_file = os.path.join(intrinsic_path, 'right_rear', 'ocam_intrinsics.txt')
            else:
                assert(False)
