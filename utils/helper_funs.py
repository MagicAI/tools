        ...
        for task in ['task_vehicle', 'task_barrier', 'task_road_traffic_Sign', 'task_TrafficLight', 'task_SpeedLimitSign']:
            ...
            for obj in objs:
                ...
                # tlight
                    ...
                    catenm = 'tsign'
                elif catenm in ['plastic-traffic-barrier', 'Safety-Crash-Barrels', 'cement-traffic-barrier', 'safety-crash-barrels',  'safety-crash-barrel']:
                    catenm = 'barrier'
